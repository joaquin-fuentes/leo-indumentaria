        ...
        <div>
            <section className="container my-3">
                <div
                    ...
                    <article data-aos="fade-up" className=" cardSeccion col-11 col-md-5 col-lg-3   card text-center  mx-1 shadow p-1 mb-2  rounded ">
                    ...
                    <article data-aos="fade-up" className=" cardSeccion col-11 col-md-5 col-lg-3 mx-3 card text-center  mx-1 shadow p-1 mb-2  rounded">
                        <aside className="card-body">
