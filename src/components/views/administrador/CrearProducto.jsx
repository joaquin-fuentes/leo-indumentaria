...
import { consultaCrearProducto, obtenerProductos } from "../../helpers/prendas";
...
const CrearProducto = ({ setProductos }) => {
        ...
        <>
            <Button onClick={handleShow} variant="primary" className=" m-1 d-flex justify-content-center align-items-center flex-column">
                <div className="d-flex justify-content-center align-items-center">
                    <IoAdd />
                    <p className="m-0">Crear Producto</p>
                </div>
            </Button>
            <Container>
                        ...
                        <Form onSubmit={handleSubmit(onSubmit)}>
                            ...
                            {/* <Form.Group className="mb-3">
                                ...
                                <Form.Select aria-label="Default select example" {
                                    ...
                                    <option value="Deportiva">Deportiva</option>
                                    <option value="Formal">Formal</option>
                                    <option value="Otro">Formal</option>
                                </Form.Select>
                                <Form.Text className="text-danger">
                                    {errors.tipo?.message}
                                </Form.Text>
